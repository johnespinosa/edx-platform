...
def toc_for_course(request, course, active_chapter, active_section, field_data_cache):
    ...
    with modulestore().bulk_operations(course.id):
        ...
        # The user may be able to skip an entrance exam, if one is suggested
        if course_has_entrance_exam(course) and \
                user_can_access_courseware_with_entrance_exam(request, request.user, course):
        ...
        for chapter in chapters:
            ...
            toc_chapters.append({'display_name': chapter.display_name_with_default,
