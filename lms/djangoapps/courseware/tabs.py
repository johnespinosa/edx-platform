...
from courseware.entrance_exams import user_can_access_courseware_with_entrance_exam
...
def get_course_tab_list(course, user):
    ...
    request.user = user
    skip_entrance_exam = user_can_access_courseware_with_entrance_exam(request, user, course)
    course_tab_list = []
    for tab in xmodule_tab_list:
        if not skip_entrance_exam:
